...
<a href="loginForm.jsp">로그인</a>
  ...
  <form action="memberInsertPro.jsp" method = "post" id="frm">
   ...
   <!--  id 공백인식 위해 "" 넣기, 안넣어도 인식은 하지만 공백까지를 잡는다. -->
    
      <div class="row">
    <div class="col">
      <label for="userid">UserID:</label> <input type="text" class="form-control" id="userid" placeholder="Enter UserID" name="userid" readonly="readonly">
    </div>
